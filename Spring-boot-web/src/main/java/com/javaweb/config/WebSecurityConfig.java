...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                http.csrf().disable()
                .authorizeRequests()
                        .antMatchers("/admin/user-edit", "/admin/user-edit/{id}", "/admin/building-edit", "/admin/user-list").hasAnyRole("MANAGER")
                        .antMatchers("/admin/building-edit-{id}").hasAnyRole("MANAGER", "STAFF")
